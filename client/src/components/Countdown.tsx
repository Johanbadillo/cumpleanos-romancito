  ...
  const TimeUnit = ({ value, label }: { value: number; label: string }) => (
    <div className="flex flex-col items-center">
      <div className="relative mb-3">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-rosa-pastel to-celeste-romantic rounded-full blur-md opacity-30" style={{ animationName: 'pulse', animationDuration: '2s', animationTimingFunction: 'cubic-bezier(0.4, 0, 0.6, 1)', animationIterationCount: 'infinite' }}></div>
  ...
  if (timeRemaining.isOver) {
    return (
      <div className="romantic-card text-center py-12 fade-in-up">
        ...
        <div className="mt-6 text-4xl" style={{ animationName: 'bounce', animationDuration: '1s', animationTimingFunction: 'cubic-bezier(0.68, -0.55, 0.265, 1.55)', animationIterationCount: 'infinite' }}>
          🎉 💕 🎂
        </div>
      </div>
    );
  ...
  return (
    <div className="romantic-card text-center py-8 md:py-12 fade-in-up">
      ...
      <div className="mt-8 md:mt-12 flex justify-center gap-4">
        <span className="text-2xl" style={{ animationName: 'pulse', animationDuration: '2s', animationTimingFunction: 'cubic-bezier(0.4, 0, 0.6, 1)', animationIterationCount: 'infinite' }}>🌷</span>
        <span className="text-2xl" style={{ animationName: 'pulse', animationDuration: '2s', animationTimingFunction: 'cubic-bezier(0.4, 0, 0.6, 1)', animationIterationCount: 'infinite', animationDelay: '0.2s' }}>
          ✨
        </span>
        <span className="text-2xl" style={{ animationName: 'pulse', animationDuration: '2s', animationTimingFunction: 'cubic-bezier(0.4, 0, 0.6, 1)', animationIterationCount: 'infinite', animationDelay: '0.4s' }}>
          🌙
        </span>
      </div>
    </div>
